...
NODES = [
    ...
    ("ZAROSLYAK", "Zaroslyak base", 48.1636, 24.5364, 1220, "Vorokhta"),
    ("HOVERLA", "Hoverla summit", 48.1601, 24.5003, 2061, "Yasinia"),
    ("KOZMESHCHYK", "Kozmeshchyk clearing", 48.1846, 24.4726, 1240, "Yasinia"),
    ("LAZESHCHYNA", "Lazeshchyna village", 48.2364, 24.5169, 682, "Yasinia"),
    ("PETROS", "Petros summit", 48.1728, 24.4139, 2020, "Rakhiv"),
    ("KVASY", "Kvasy village", 48.1461, 24.2811, 600, "Rakhiv"),
    ("BRESKUL_SADDLE", "Breskul saddle", 48.1494, 24.5106, 1850, "Vorokhta"),
    ("POZHYZHEVSKA", "Pozhyzhevska meteo station", 48.1466, 24.5306, 1822, "Vorokhta"),
    ("NESAMOVYTE", "Lake Nesamovyte", 48.1225, 24.5342, 1750, "Vorokhta"),
    ("TURKUL", "Turkul summit", 48.1183, 24.5250, 2036, "Vorokhta"),
    ("SHPYTSI", "Shpytsi rocks", 48.1094, 24.5697, 1863, "Verkhovyna"),
    ("SMOTRYCH", "Smotrych summit", 48.0653, 24.6117, 1894, "Verkhovyna"),
    ("POP_IVAN", "Pip Ivan summit (observatory)", 48.0489, 24.6272, 2028, "Verkhovyna"),
    ("MARICHEIKA", "Lake Maricheika", 48.0561, 24.6503, 1510, "Verkhovyna"),
    ("SHYBENE", "Shybene hamlet", 48.0208, 24.7092, 780, "Verkhovyna"),
    ("FOREST_PRUT", "Prut valley trail junction", 48.1400, 24.5500, 1400, "Vorokhta"),
    ("BYSTRETS", "Bystrets village", 48.1069, 24.6300, 900, "Verkhovyna"),
    ("DZEMBRONIA", "Dzembronia village", 48.0800, 24.6636, 850, "Verkhovyna"),
]
